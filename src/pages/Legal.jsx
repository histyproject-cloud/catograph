...
const SECTIONS = {
  ...
  terms: {
    ...
    content: [
      ...
      { heading: '제6조 (요금 및 결제)', body: `① 무료(Free) 플랜은 기본 기능을 무료로 제공합니다.\n\n② Pro 플랜 요금은 월 3,300원 또는 연 29,900원(25% 할인)입니다.\n\n③ 신규 가입 후 첫 30일은 Pro 플랜을 무료로 체험할 수 있습니다.\n\n④ 무료 체험 종료 후 자동으로 Pro 플랜 결제가 진행되며, 결제 전 이메일로 안내해 드립니다.\n\n⑤ 결제는 토스페이먼츠를 통해 처리되며, 신용카드 및 체크카드 결제가 가능합니다.` },
      { heading: '제7조 (환불 정책)', body: `① 이용자는 결제일로부터 7일 이내에 청약철회를 신청할 수 있으며, 전액 환불해 드립니다.\n\n② 단, 다음의 경우에는 청약철회가 제한될 수 있습니다.\n\n• 서비스를 상당 부분 이용한 경우\n• 무료 체험 기간(30일)이 종료되어 유료 서비스로 전환된 후 7일이 경과한 경우\n\n③ 환불 신청은 이메일(histy.cartographic@gmail.com)로 접수하실 수 있습니다.\n\n④ 본 환불 정책은 전자상거래 등에서의 소비자보호에 관한 법률에 따릅니다.` },
